...
import ModalThemSinhVien from "../pdt/components/ModalThemSinhVien";
import ModalCapNhatSinhVien from "../pdt/components/ModalCapNhatSinhVien";
  ...
  return (
    <section className="main__body">
      <div className="body__title">
        <p className="body__title-text">QUẢN LÝ SINH VIÊN</p>
      </div>
