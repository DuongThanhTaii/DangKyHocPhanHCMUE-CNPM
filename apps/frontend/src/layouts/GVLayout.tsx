...
export default function GVLayout() {
  ...
  // ✅ Chặn người không phải giáo viên hoặc chưa đăng nhập
  if (!token || !user || user.loai_tai_khoan !== "giang_vien") {
            ...
            <ul className="navbar__list">
              <li className="navbar__item">
                <NavLink to="dashboard" className={getNavLinkClass}>
                  ...
                  <span className="navbar__link-text">Trang chủ</span>
                </NavLink>
              </li>
              ...
              <li className="navbar__item">
                <NavLink to="lop-hoc-phan" className={getNavLinkClass}>
                  ...
                  <span className="navbar__link-text">Quản lý lớp học</span>
                </NavLink>
              </li>

              <li className="navbar__item">
                <NavLink to="diem-danh" className={getNavLinkClass}>
                  <span className="navbar__link-icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                  ...
                  <span className="navbar__link-text">Điểm danh</span>
                </NavLink>
              </li>

              <li className="navbar__item">
                <NavLink to="nhap-diem" className={getNavLinkClass}>
                  <span className="navbar__link-icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                  ...
                  <span className="navbar__link-text">Nhập điểm</span>
                </NavLink>
              </li>

              <li className="navbar__item">
                <NavLink to="lich-giang-day" className={getNavLinkClass}>
                  <span className="navbar__link-icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                  ...
                  <span className="navbar__link-text">Lịch giảng dạy</span>
                </NavLink>
              </li>
              ...
              <li className="navbar__item">
                <NavLink to="bao-cao" className={getNavLinkClass}>
                  ...
                  <span className="navbar__link-text">Báo cáo</span>
                </NavLink>
              </li>
            </ul>
          </nav>
      ...
      <main className="layout__main">
        <header className="header__menu">
          ...
          <h1 className="header__title">
            HỆ THỐNG GIẢNG VIÊN - TRƯỜNG ĐH SƯ PHẠM TP.HCM
          </h1>
